...
#
#python -m kcm.eval \
#  --exp_name="nqswap-gemma-2-7b-${K_SHOT}shot-${NUM_EXAMPLES}examples-closebook" \
...
#
#python -m kcm.eval \
#  --exp_name="nqswap-gemma-2-7b-${K_SHOT}shot-${NUM_EXAMPLES}examples-openbook" \
#  --model_path="google/gemma-2-2b" \
#  --k_shot=${K_SHOT} \
#  --seed=42 \
#  --batch_size=1 \
...
#
#python -m kcm.eval \
#  --exp_name="nqswap-gemma-2-7b-${K_SHOT}shot-${NUM_EXAMPLES}examples-openbook-noconflict" \
#  --model_path="google/gemma-2-2b" \
#  --k_shot=${K_SHOT} \
#  --seed=42 \
#  --batch_size=1 \
