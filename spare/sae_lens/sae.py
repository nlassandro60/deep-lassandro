...
from spare.sae_lens.config import DTYPE_MAP
from spare.sae_lens.toolkit.pretrained_sae_loaders import (
    NAMED_PRETRAINED_SAE_LOADERS,
    handle_config_defaulting,
    read_sae_from_disk,
)
from spare.sae_lens.toolkit.pretrained_saes_directory import (
...
class SAE(HookedRootModule):
    ...
    def decode(
            self, feature_acts: Float[torch.Tensor, "... d_sae"], top_indices=None
